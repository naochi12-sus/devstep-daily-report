            ...
            <main className="max-w-4xl mx-auto px-6 py-10">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        className="bg-[#2dd4bf] hover:bg-[#25b5a3] text-white px-5 py-2.5 rounded-md font-semibold flex items-center gap-2 text-sm transition-colors"
                    >
...
function Header({ userName }: { userName: string }) {
    const avatarUrl = `https://api.dicebear.com/7.x/shapes/svg?seed=${userName || "guest"}`;
    return (
        <header className="bg-[#1e3a8a] text-white shadow-md sticky top-0 z-10">
            <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                <div className="text-xl font-bold">Team Activity Log</div>
...
// anyを排除し、定義したReportCardPropsを適用
function ReportCard({
    initials,
    name,
    department,
    ...
    return (
        ...
        >
            ...
            >
                <div className="h-11 w-11 rounded-full bg-white flex items-center justify-center text-slate-500 font-bold border">
                    {initials}
                </div>
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <span
                            className={`${departmentColor} text-white text-[11px] px-2.5 py-0.5 rounded-full font-bold`}
                        >
                            {department}
                        </span>
                    </div>
            ...
            <div className="px-6 pb-4 pt-2">
                ...
                <p className="text-slate-500 text-sm line-clamp-2">{content}</p>
...
function FilterBar() {
    return (
        <div className="flex gap-3 mb-8">
            <select className="px-4 py-2 rounded-md border border-slate-200 bg-white text-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-[#2dd4bf]">
